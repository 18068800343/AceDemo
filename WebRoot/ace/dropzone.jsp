...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/ace/assets/css/dropzone.css" />
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div id="dropzone">
									<form action="//../ace/dummy.html" class="dropzone">
										<div class="fallback">
...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath}/ace/assets/js/dropzone.min.js"></script>
