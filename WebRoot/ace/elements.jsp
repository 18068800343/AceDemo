									...
									<div class="col-sm-6">
										<div class="tabbable tabs-below">
											...
											<ul class="nav nav-tabs" id="myTab2">
												...
												<li>
													<a data-toggle="tab" href="#profile2">个人简介</a>
												</li>
									...
									<div class="col-sm-6">
										<div class="tabbable">
											<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
												...
												<li>
													<a data-toggle="tab" href="#profile4">个人简介</a>
												</li>
...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath}/ace/assets/js/spin.min.js"></script>
