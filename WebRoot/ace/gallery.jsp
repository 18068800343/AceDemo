...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/ace/assets/css/colorbox.css" />
...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath}/ace/assets/js/jquery.colorbox-min.js"></script>
