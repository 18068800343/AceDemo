...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath}/ace/assets/js/jqGrid/jquery.jqGrid.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/jqGrid/i18n/grid.locale-en.js"></script>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					editurl: $path_base+"/../ace/dummy.html",//nothing is saved
