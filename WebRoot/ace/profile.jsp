...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/ace/assets/css/jquery-ui-1.10.3.custom.min.css" />
		<link rel="stylesheet" href="${pageContext.request.contextPath}/ace/assets/css/jquery.gritter.css" />
		<link rel="stylesheet" href="${pageContext.request.contextPath}/ace/assets/css/select2.css" />
		<link rel="stylesheet" href="${pageContext.request.contextPath}/ace/assets/css/bootstrap-editable.css" />
										...
										<div class="col-xs-12 col-sm-3 center">
											<div>
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="${pageContext.request.contextPath}/ace/assets/avatars/profile-pic.jpg" />
												</span>
													...
													<div class="widget-main padding-8">
														<div id="profile-feed-1" class="profile-feed">
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="Alex Doe's avatar" src="${pageContext.request.contextPath}/ace/assets/avatars/avatar5.png" />
															...
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="Susan Smith's avatar" src="${pageContext.request.contextPath}/ace/assets/avatars/avatar1.png" />
															...
															<div class="profile-activity clearfix">
																<div>
																	<img class="pull-left" alt="David Palms's avatar" src="${pageContext.request.contextPath}/ace/assets/avatars/avatar4.png" />
											...
											<div class="tab-content no-border padding-24">
												<div id="home" class="tab-pane in active">
													<div class="row">
														<div class="col-xs-12 col-sm-3 center">
															<span class="profile-picture">
																<img class="editable img-responsive" alt="Alex's Avatar" id="avatar2" src="${pageContext.request.contextPath}/ace/assets/avatars/profile-pic.jpg" />
															</span>
													...
													<div class="profile-users clearfix">
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/ace/assets/avatars/avatar4.png" alt="Bob Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/ace/assets/avatars/avatar1.png" alt="Rose Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/ace/assets/avatars/avatar.png" alt="Jim Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/ace/assets/avatars/avatar5.png" alt="Alex Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/ace/assets/avatars/avatar2.png" alt="Phil Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/ace/assets/avatars/avatar3.png" alt="Susan Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/ace/assets/avatars/avatar1.png" alt="Jennifer Doe's avatar" />
																	</a>
																</div>
														...
														<div class="itemdiv memberdiv">
															<div class="inline position-relative">
																<div class="user">
																	<a href="#">
																		<img src="${pageContext.request.contextPath}/ace/assets/avatars/avatar3.png" alt="Alexa Doe's avatar" />
																	</a>
																</div>
...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath}/ace/assets/js/bootstrap.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/typeahead-bs2.min.js"></script>

		<!-- page specific plugin scripts -->

		<!--[if lte IE 8]>
		  <script src="${pageContext.request.contextPath}/ace/assets/js/excanvas.min.js"></script>
		<![endif]-->

		<script src="${pageContext.request.contextPath}/ace/assets/js/jquery-ui-1.10.3.custom.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/jquery.ui.touch-punch.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/jquery.gritter.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/bootbox.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/jquery.slimscroll.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/jquery.easy-pie-chart.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/jquery.hotkeys.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/bootstrap-wysiwyg.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/select2.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/date-time/bootstrap-datepicker.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/fuelux/fuelux.spinner.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/x-editable/bootstrap-editable.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/x-editable/ace-editable.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/jquery.maskedinput.min.js"></script>
