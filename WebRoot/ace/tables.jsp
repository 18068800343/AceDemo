...
<![endif]-->
		...
		<script src="${pageContext.request.contextPath}/ace/assets/js/jquery.dataTables.min.js"></script>
		<script src="${pageContext.request.contextPath}/ace/assets/js/jquery.dataTables.bootstrap.js"></script>
